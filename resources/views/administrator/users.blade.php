...
@section('title', Auth::user()->accountType->name . ' | Global User Manager')
@section('crumb', 'Global User Manager')
...
@include('administrator.snapins.view-user')
@include('administrator.snapins.new-user')

<div class="container mt-3">
	<div class="row">
		<div class="action-bar pt-1 rounded">
			<button class="toggle-button ripple input-tip" onclick="viewNewUserPanel()">New User</button> •
...
@section('scripts')
	...
	<script type="text/javascript" src="/js/views/administrator/users.js"></script>
