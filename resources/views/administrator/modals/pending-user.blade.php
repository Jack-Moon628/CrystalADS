<div id="pendingUserModal" class="modal fade" tabindex="-1">
	<div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
		<div class="modal-content border-0">
			<div class="modal-header mb-2">
				<h5 class="modal-title ml-4">Review User Application</h5>
			</div>
			...
			<div class="modal-body mt-0 pt-0 text-center" style="max-height: 500px; overflow-y: auto;">
				<div class="details-form">
		            <div class="input-item">
						...
						<input id="emailReview" type="text" disabled>
		            </div>

		            <div class="input-item">
		                <span>Username</span>
						<input id="usernameReview" type="text" disabled>
		            </div>

		            <div class="input-item">
		                <span>Account Type</span>
						<input id="accountTypeReview" type="text" disabled>
		            </div>

		            <div class="input-item">
		                <span>Company</span>
						<input id="companyReview" type="text" disabled>
		            </div>

		            <div class="input-item">
		                <span>Registered</span>
						<input id="registeredReview" type="text" disabled>
		            </div>
		        </div>
			</div>
